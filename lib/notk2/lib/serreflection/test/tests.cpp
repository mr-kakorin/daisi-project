...
{
    ASSERT_FALSE(bool(srfl::read_json_string<TestJSON_1>(json_test_1)));

    auto res_2 = srfl::read_json_string<TestJSON_1>(json_test_2);

    ASSERT_TRUE(bool(res_2));
    ...
    ASSERT_TRUE(bool(res_22));

    test(*res_22, 6, 8);
}
TEST_F(TEST_SERREFLECTION, test2)
{
    ASSERT_FALSE(bool(srfl::read_json_string<TestJSON_1>(json_test_3)));
    ASSERT_FALSE(bool(srfl::read_json_string<TestJSON_1>(json_test_4)));
}
TEST_F(TEST_SERREFLECTION, test3)
{
    auto res_1 = srfl::read_json_string<test_srfl::TestJSON_2>(json_test_1);

    ASSERT_TRUE(bool(res_1));
